...
Native LDraw is right-handed, -Y up, 20LDU per stud, 8LDU per plate, 24LDU per brick; ~0.4mm/LDU. Use each part's actual origin. Rotation is row-major a b c d e f g h i, orthonormal determinant +1; no reflection/scale/shear. Part-internal matrices remain original. Positions permit fractional values.
